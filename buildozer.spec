...
requirements = python3==3.7.6, kivy==2.2.1, kivymd==1.2.0.dev0 , sdl2_ttf==2.0.15, pillow, et_xmlfile,openpyxl,requests
...
# android.permission.WRITE_EXTERNAL_STORAGE, android.permission.READ_EXTERNAL_STORAGE, android.permission.requestLegacyExternalStorage,android.permission.MANAGE_EXTERNAL_STORAGE
